...
export class CustomColor {
    ...
    static fromHTML(color: string): CustomColor {
        if(color.startsWith('#')) color = color.substring(1);
        return new CustomColor(parseInt(color.substring(0, 2), 16), parseInt(color.substring(2, 4), 16), parseInt(color.substring(4, 6), 16));
    }
